...
async def get_company_cost(
    ...
    return await compute_cost_summary(session, scope="company", window_days=window_days, project=project)
...
async def list_employee_costs(
    ...
    return await compute_cost_summary_by_employee(session, window_days=window_days, project=project)
...
async def get_team_cost(
    ...
    return await compute_cost_summary(
        session, scope="team", scope_id=team_id, window_days=window_days, project=project
    )
...
async def get_employee_cost(
    ...
    return await compute_cost_summary(
        session, scope="employee", scope_id=employee_id, window_days=window_days, project=project
    )
